...
CK_VISIBLE_PUBLIC int CkFtp2_getAllocateSize(HCkFtp2 cHandle);
CK_VISIBLE_PUBLIC void CkFtp2_putAllocateSize(HCkFtp2 cHandle, int newVal);
...
CK_VISIBLE_PUBLIC int CkFtp2_getAsyncBytesReceived(HCkFtp2 cHandle);
...
CK_VISIBLE_PUBLIC int CkFtp2_getAsyncBytesSent(HCkFtp2 cHandle);
...
CK_VISIBLE_PUBLIC int CkFtp2_getAsyncPercentDone(HCkFtp2 cHandle);
