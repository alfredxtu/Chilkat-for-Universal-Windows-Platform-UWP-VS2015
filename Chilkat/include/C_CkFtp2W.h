...
CK_VISIBLE_PUBLIC int CkFtp2W_getAllocateSize(HCkFtp2W cHandle);
CK_VISIBLE_PUBLIC void CkFtp2W_putAllocateSize(HCkFtp2W cHandle, int newVal);
...
CK_VISIBLE_PUBLIC int CkFtp2W_getAsyncBytesReceived(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC int CkFtp2W_getAsyncBytesSent(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC int CkFtp2W_getAsyncPercentDone(HCkFtp2W cHandle);
